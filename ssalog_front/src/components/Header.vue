          ...
          <v-col cols="1" class="d-none d-md-flex mr-6">
            <v-btn text block @click="goSite('https://www.acmicpc.net/')"
              ><img
                ...
                title="백준으로 이동합니다."
                style="height:1.5rem;"
                src="https://d2gd6pc034wcta.cloudfront.net/images/logo@2x.png"/><img
                v-show="isDark"
                title="백준으로 이동합니다."
                style="height:1.5rem;"
                src="@/assets/images/baekjoon_dark.png"
            /></v-btn>
          </v-col>
...
export default {
  ...
  computed: mapState(["userThumbnail", "nickname", "accessToken", "isDark"]),
  methods: {
    userMenu(idx) {
      if (idx === 0) {
        this.$router.push({
