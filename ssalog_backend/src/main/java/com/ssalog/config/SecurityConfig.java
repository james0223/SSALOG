...
import com.ssalog.jwt.JwtAuthenticationEntryPoint;
import com.ssalog.jwt.JwtRequestFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
   ...
   @Override 	
	public void configure(WebSecurity web) throws Exception {
	   web.ignoring().antMatchers("/v2/api-docs", "/swagger-resources/**", "/swagger-ui.html", "/webjars/**", "/swagger/**", "/upload/resources/upload/**");
	}
