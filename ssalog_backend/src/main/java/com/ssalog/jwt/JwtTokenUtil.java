...
public class JwtTokenUtil implements Serializable {
    ...
    public static final long JWT_ACCESS_TOKEN_VALIDITY = 10;//30 * 60;//30 * 60; //30분
    public static final long JWT_REFRESH_TOKEN_VALIDITY = 2*60;//24 * 60 * 60 * 7; //일주일
