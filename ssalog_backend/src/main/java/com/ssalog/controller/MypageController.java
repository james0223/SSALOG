...
public class MypageController {
	...
	public ResponseEntity<String> upload_img(@RequestParam("filename") MultipartFile multipartFile, @RequestParam("username") String username) {
		int flag =fileService.fileUpload(multipartFile, username);
		if(flag == 1) {
	...
	public ResponseEntity<String> delete_profile_img(@RequestParam("username") String username){
